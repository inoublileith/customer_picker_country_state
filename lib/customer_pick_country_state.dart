library customer_pick_country_state;

import 'package:customer_pick_country_state/i18n/country_localization.dart';
import 'package:customer_pick_country_state/model/dropdown_with_search.dart';
...
class CountryPickCountry extends StatefulWidget {
  ...
  @override
  CountryPickCountryState createState() => CountryPickCountryState();
}

class CountryPickCountryState extends State<CountryPickCountry> {
  List<String?> _cities = [];
